...
def printDocumentation(fileName):
    ...
    # Catching an error if the entered file name in invalid
        ...
        print("\nPlease check if Documentation.txt is present in the same directory or not!\n")
        return
...
try:
    ...
    df_customer = pd.DataFrame(columns=['Customer_ID', 'Name', 'State', 'Address'])

#class Production
class Customer_Details:
    def __init__(self,customer_id,customer_name,customer_state,customer_address):
        self.customer_id = customer_id          #int
        self.customer_name = customer_name      #string
        self.customer_state = customer_state    #string
        self.customer_address = customer_address#string
...
# delete row function to delete a particular file in production dataframe
    def Customer_deleteRow(self):
            df_customer1 = df_customer.query(f'Customer_ID!={self.customer_id}')
...
try:
    ...
    #setting dataframes with unique names if Excels sheet does not exists
    df_employee = pd.DataFrame(columns=['Employee_ID', 'Name', 'Date of Joining', 'Department'])
...
# delete row function to delete a particular file in production dataframe
    def Employee_deleteRow(self):
            df_employee1 = df_employee.query(f'Employee_ID!={self.employee_id}')
    ...
    if ch_Cust == 'Y':
        ...
        if option == 1 or option == 2 or option == 3:
            ...
            while num > 0:
                ...
                if option == 1:
                    id = int(input("Enter the customer ID(int)\n"))
    ...
    if ch_Emp == 'Y':
        ...
        if option == 1 or option == 2 or option == 3:
            ...
            while num > 0:
                ...
                # Option for adding a row
                if option == 1:
                    id = int(input("Enter the employee ID(int)\n"))
    ...
    if ch_Prod == 'Y':
        ...
        if option == 1 or option == 2 or option == 3:
            ...
            while num > 0:
                ...
                # Option for adding a row
                if option == 1:
                    punitNo = int(input("Enter Production Unit Number(int)\n"))
                    fuelOutput = int(input("Enter the fuel output\n"))
                    pcost = int(input("Enter Production Cost\n"))
                    date = input("Enter date of arrival (dd/mm/yyyy)\n")
        ...
        if option == 1 or option == 2 or option == 3:
            ...
            while num > 0:
                ...
                if option == 1:
                    ...
                    date = input('Enter Date at which customer made the demand (dd/mm/yyyy)\n')
...
student_file_status = True
try:
    f = open("Student.txt", "r")
except FileNotFoundError:
        print("Please check if Student.txt is present in the same directory or not!\n")
        student_file_status = False
if student_file_status == True:
    print(f.read())
